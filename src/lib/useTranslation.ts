...
const loadClientDictionary = async (locale: Locale): Promise<Dictionary> => {
  ...
  try {
    ...
    console.error(`Failed to load client dictionary for locale: ${locale}`, error)
  ...
  useEffect(() => {
    const loadDictionary = async () => {
      ...
      try {
        ...
        setDictionary({
          common: { loading: 'Loading...', error: 'Error', retry: 'Retry', bookNow: 'Book Now', perPerson: 'per person', skipToMainContent: 'Skip to main content' },
          header: { logoAlt: 'Pony Club', location: 'Acheron River, Greece' },
          welcome: { description: '', title: '', intro: '', history: '', callToAction: '', features: { safety: '', family: '', memorable: '' } },
          packages: { raftingRiding: { title: '', tag: '', integration: '', ageRequirement: '', activities: { rafting: '', riding: '', hiking: '' }, safetyNote: '', price: '' }, kayakingRidingTrekking: { title: '', integration: '', ageRequirement: '', activities: { kayak: '', riding: '', trekking: '' }, safetyNote: '', price: '' } },
          navigation: { home: '', map: '', activities: '', offers: '', more: '', contactUs: '', familyPackages: '', safetyInfo: '', bookFamilyExperience: '' },
          weather: { unavailable: '', location: '', details: { feelsLike: '', humidity: '', index: '', cloudCover: '', pressure: '' } },
          metadata: { title: '', description: '', keywords: '', openGraph: { title: '', description: '', imageAlt: '' }, twitter: { title: '', description: '' } },
