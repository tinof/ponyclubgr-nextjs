...
// Lazy load the BokunProductPage component with a skeleton fallback
...
interface RidingClientPageProps {
  dictionary: Dictionary;
}

export function RidingClientPage({ dictionary }: RidingClientPageProps) {
  return (
    <div className="px-4 sm:px-6 py-6">
      <BokunProductPage
        experienceId="1020659"
        dictionary={dictionary}
        className="w-full"
      />
    </div>
