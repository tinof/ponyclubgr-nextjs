    ...
    <div className="mb-6">
      ...
      <div className="grid grid-cols-1 gap-3">
              ...
              <div className="flex items-center space-x-0.5">
                {[...Array(5)].map((_, i) => (
                  <Star
                    ...
                    stroke={
                      i < Math.floor(averageRating) ? '#FFD700' : '#D1D5DB'
                    }
                  />
                ))}
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-white/60 flex items-center justify-between opacity-50">
          ...
          <div className="text-sm text-gray-500">89 reviews</div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-white/60 flex items-center justify-between opacity-50">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                <path
                  fill="white"
                  d="M8.5 10.5c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5 1.5-.7 1.5-1.5-.7-1.5-1.5-1.5zm7 0c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5 1.5-.7 1.5-1.5-.7-1.5-1.5-1.5z"
                />
                <path
                  fill="white"
                  d="M12 7c-3.3 0-6 2.7-6 6 0 .6.1 1.1.2 1.6l5.8-5.8 5.8 5.8c.1-.5.2-1 .2-1.6 0-3.3-2.7-6-6-6z"
                />
              </svg>
              <span className="text-sm font-medium text-gray-700">
                TripAdvisor
          ...
          {/* Review Count Placeholder */}
          <div className="text-sm text-gray-500">67 reviews</div>
        </div>
      </div>
    </div>
  );
