      ...
      <div className="bg-white rounded-3xl shadow-premium overflow-hidden border border-white/40 relative">
        ...
        <div className="p-5">
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <button className="bg-[#5a6f5a] text-white font-bold py-3 px-6 rounded-xl text-base hover:bg-opacity-90 transition shadow-md">
              Book Now
            </button>
          </div>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-premium overflow-hidden border border-white/40">
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <button className="bg-[#5a6f5a] text-white font-semibold py-2 px-4 rounded-xl text-sm hover:bg-opacity-90 transition shadow-md">
              Book Now
            </button>
          </div>
        </div>
